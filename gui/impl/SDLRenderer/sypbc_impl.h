     ...
     rgba col)
{
    if (r == 0) {
        ...
        roundedRectangleRGBA(surface, x, y, x + w, y + h, r, col.r, col.g,
                             col.b, col.a);
    }
}

static void
fill_rect(SDL_Surface *surface,
          short x,
          short y,
          unsigned short w,
          unsigned short h,
          ...
          rgba col)
{
    if (r == 0) {
        ...
        roundedBoxRGBA(surface, x, y, x + w, y + h, r, col.r, col.g, col.b,
                       col.a);
    }
}
...
line(SDL_Surface *surface,
     ...
     rgba col)
{
    thickLineRGBA(surface, x0, y0, x1, y1, line_thickness, col.r, col.g, col.b,
                  col.a);
}
