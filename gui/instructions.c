...
draw_push_filled_rect(struct sypbc_draw *draw_context,
                      ...
                      rgba color)
{
    struct sypbc_draw_filled_rect *rect =
      malloc(sizeof(struct sypbc_draw_filled_rect));
    rect->x = x;
    rect->y = y;
    rect->width = width;
    rect->height = height;
...
draw_push_filled_circle(struct sypbc_draw *draw_context,
                        ...
                        rgba color)
{
    struct sypbc_draw_filled_circle *circle =
      malloc(sizeof(struct sypbc_draw_filled_circle));
    circle->x = x;
    circle->y = y;
    circle->color = color;
    circle->radius = radius;
...
free_draw(struct sypbc_draw *draw_context)
{
    for (size_t i = 0; i < draw_context->instruction_count; i++)
        free(draw_context->draw_list[i].inst);
